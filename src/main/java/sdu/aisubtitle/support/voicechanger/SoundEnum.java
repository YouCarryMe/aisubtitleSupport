package sdu.aisubtitle.support.voicechanger;
...
public enum SoundEnum {
    ...
    XIONGHAIZI(0.73, 0.73, "熊孩子", 4, dispatcher -> {
    }),
    /**
     * dispatcher.addAudioProcessor(new DelayEffect(0.2, 0.24, 12000) );
     */
    KUNSHOU(1.55, 1.55, "困兽", 5, dispatcher -> dispatcher.addAudioProcessor(new DelayEffect(0.2, 0.24, 12000))),
    /**
     * dispatcher.addAudioProcessor(new DelayEffect(0.2, 0.24, 12000) );
     */
    ZHONGJIXIE(1.50, 1.50, "重机械", 6, dispatcher -> dispatcher.addAudioProcessor(new DelayEffect(0.2, 0.24, 12000))),
    /**
     ...
     */
    GANMAO(1.05, 1.05, "感冒", 7, dispatcher -> {
        dispatcher.addAudioProcessor(new DelayEffect(0.2, 0.24, 12000));
        dispatcher.addAudioProcessor(new ZeroCrossingRateProcessor());
    }),
    /**
